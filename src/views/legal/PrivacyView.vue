	...
	<div class="container container-sm legal">
		...
		<section>
			...
			<p>
				...
				веб-сайта https://enlisted-stats.web.app/ (далее — Оператор).
			</p>
			<ul>
				<li>
		...
		<section>
			...
			<ul>
				...
				<li>
					...
					сети интернет по сетевому адресу https://enlisted-stats.web.app/.
				</li>
				<li>
		...
		<section>
			...
			<ul>
				...
				<li>
					...
					nikita96piter@gmail.com с пометкой «Актуализация персональных данных».
				</li>
				<li>
					...
					на электронный адрес Оператора nikita96piter@gmail.com с пометкой
		...
		<section>
			...
			<ul>
				<li>
					...
					Оператору с помощью электронной почты nikita96piter@gmail.com.
				</li>
				<li>
				...
				<li>
					...
					сети Интернет по адресу https://enlisted-stats.web.app/privacy.
				</li>
			</ul>
		</section>
	</div>
